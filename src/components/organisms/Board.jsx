...
import { Button, ConnectionLine } from '../atoms'
    ...
    <Xwrapper>
      <div className="min-h-screen flex flex-col">
            ...
            <div className="flex items-center gap-3">
              {connectingFrom && (
                <div className="flex items-center gap-2">
                  <span className="text-sm text-connect font-medium">
                    ● Conectando… selecciona otra tarjeta
                  </span>
                  <Button variant="ghost" size="sm" onClick={cancelConnection}>
                    Cancelar
                  </Button>
                </div>
              )}
        ...
        >
          ...
          {/* Botón para crear nuevo grupo — fuera del grid, centrado */}
        ...
        {/* Líneas de conexión entre tarjetas */}
        {connections.map((conn) => (
          <ConnectionLine
            key={conn.id}
            start={conn.fromCardId}
            end={conn.toCardId}
